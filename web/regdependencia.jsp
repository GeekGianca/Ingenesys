...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
            <div class="container">
                <a class="navbar-brand" href="irdependencia.do">Ingenesys</a>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <form action="regdependencia.do" method="POST">
                        <div class="form-group">
                            <label for="codigoCiudad">Codigo Dependencia</label>
                            <input type="number" class="form-control is-invalid" name="codigoDependencia" id="codigoDependencia" placeholder="01xxxx" required>
                            <div class="invalid-feedback">
                                Es necesario el codigo de la dependencia
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="nombreCiudad">Nombre Dependencia</label>
                            <input type="text" class="form-control is-invalid" name="nombreDependencia" id="nombreDependencia" placeholder="Nombre Dependencia">
                            <div class="invalid-feedback">
                                Es necesario el nombre de la dependencia
                            </div>
                        </div>
                        <div class="form-group">
